...
namespace Rimot.Server.Pages
{
    ...
    public partial class ServerConfig : AuthComponentBase
    {
        ...
        private readonly List<RimotUser> _userList = new();
        ...
        private IEnumerable<RimotUser> UserList
        {
            get
            {
        ...
        private async Task SaveAndTestSmtpSettings()
        {
            ...
            var success = await EmailSender.SendEmailAsync(User.Email, "Rimot Test Email", "Congratulations! Your SMTP settings are working!", User.OrganizationID);
            if (success)
            {
        ...
        private void SetIsServerAdmin(ChangeEventArgs ev, RimotUser user)
        {
